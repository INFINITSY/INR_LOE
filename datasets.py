...
class SRNDatasetsLMDB(torch.utils.data.Dataset):
    """
    ...
    def __init__(
        self, args, root='datasets', category='cars', split="train", world_scale=1.0, 
        zero_to_one=False, resolution=128
    ):
        """
        ...
        self.base_path = os.path.join(root, 'srn_cars_lmdb', "cars_" + split)
        ...
        self.subsampled_views = args.subsampled_views
